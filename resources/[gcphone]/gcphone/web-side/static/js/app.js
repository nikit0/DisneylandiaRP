				...
				var e = h()(c.a.mark(function t() {
					...
					return c.a.wrap(function (t) {
						...
						case 0:
							...
							return t.next = 3,
							window.jQuery.get("/web-side/static/config/config.json");
						case 3:
							e = t.sent,
...
function (t, e, n) {
	...
	m = {
		...
		sounds: JSON.parse(window.localStorage.gc_sounds || null),
	...
	var v = {
		...
		backgroundURL: function (t, e) {
			return ! 0 === e.background.value.startsWith("http") ? e.background.value: "/web-side/static/img/background/" + e.background.value
		},
		coque: function (t) {
			var e = t.coque,
			n = t.config;
		...
		sounds: function(t) {
			var e = t.sounds,
				n = t.config;
			return null === e ? n && void 0 !== n.sounds_default ? n.sounds_default : {
				label: "Marimba",
				value: "marimba.ogg"
			} : e
		},
		...
		soundsLabel: function(t, e) {
			return e.sounds.label
		},
		zoom: function (t) {
			return t.zoom
		},
	...
	g = {
		...
		setSounds: function(t, e) {
			var n = t.commit;
			window.localStorage.gc_sounds = o()(e), n("SET_SOUNDS", e)
		},
		...
		resetPhone: function (t) {
			...
			e("setSounds", n.config.sounds_default),
			e("setLanguage", "pt_BR")
		}
	},
	_ = {
...
function (t, e, n) {
	...
	l = {
		...
		tchatMessages: function (t) {
			t.messagesChannel.sort(function(jayz,beep){
				return new Date(beep.time) - new Date(jayz.time);
			})
	...
	p = {
		...
		tchatAddMessage: function (t, e) {
			...
			void 0 !== n.channels.find(function (t) {
				return t.channel === a
			}) && (null !== c && (c.pause(), c = null), c = new Audio("/web-side/static/sound/tchatNotification.ogg"), c.volume = o.volume, c.play()),
...
default = {
		...
		computed: o()({},
		n.i(r.b)(["show", "zoom", "coque", "sounds", "appelsInfo", "myPhoneNumber", "volume", "tempoHide"])),
		watch: {
			appelsInfo: function (t, e) {
				// if (null !== this.appelsInfo && !0 !== this.appelsInfo.is_accepts ? (null !== this.soundCall && this.soundCall.pause(), !0 === this.appelsInfo.initiator ? this.soundCall = new Audio("/web-side/static/sound/Phone_Call_Sound_Effect.ogg") : this.soundCall = new Audio("/web-side/static/sound/ring.ogg"), this.soundCall.loop = !0, this.soundCall.volume = this.volume, this.soundCall.play()) : null !== this.soundCall && (this.soundCall.pause(), this.soundCall = null), null === t && null !== e) return void this.$router.push({
				// 	name: "home"
				// });
				if (null !== this.appelsInfo && !0 !== this.appelsInfo.is_accepts ? (null !== this.soundCall && this.soundCall.pause(), !0 === this.appelsInfo.initiator ? this.soundCall = new Audio("/web-side/static/sound/Phone_Call_Sound_Effect.ogg") : this.soundCall = new Audio("/web-side/static/sound/" + this.sounds.value), this.soundCall.loop = !0, this.soundCall.volume = this.volume, this.soundCall.play()) : null !== this.soundCall && (this.soundCall.pause(), this.soundCall = null), null === t && null !== e) return void this.$router.push({
                    name: "home"
                });
				...
				return c()(o.a.mark(function n() {
					...
					return o.a.wrap(function (n) {
						...
						case 0:
							...
							s.duration),
							null !== e.sound && void 0 !== e.sound && (i = new Audio("/web-side/static/sound/" + e.sound), i.addEventListener("ended", function () {
								i.src = null
							}), i.play());
						case 4:
						case "end":
...
default = {
		...
		computed: l()({},
		n.i(p.b)(["IntlString", "useMouse", "myPhoneNumber", "backgroundLabel", "coqueLabel", "soundsLabel", "zoom", "config", "volume", "availableLanguages"]), {
			paramList: function () {
				...
				},
				{
                    ...
                    value: this.soundsLabel,
                    onValid: "onChangeSounds",
                    values: this.config.sounds
                },
				{
					icons: "fa-search",
		...
		methods: l()({},
		n.i(p.a)(["getIntlString", "setZoon", "setBackground", "setCoque", "setSounds", "setVolume", "setLanguage", "setMouseSupport"]), {
			scrollIntoViewIfNeeded: function () {
				this.$nextTick(function () {
					document.querySelector(".select").scrollIntoViewIfNeeded()
				})
...
function (t, e) {
	t.exports = {
		...
		staticRenderFns: [function () {
			...
			[n("img", {
				attrs: {
					src: "/web-side/static/img/twitter/bird.png"
				}
			})])
		}]
	}
	...
	t.exports = {
		render: function () {
			...
			[n("button", {
				...
				style: {
					backgroundImage: "url(/web-side/static/img/icons_app/menu.png)"
				},
				on: {
					click: function (e) {
						return t.openApp({
...
function (t, e) {
	t.exports = {
		...
		staticRenderFns: [function () {
			...
			[n("img", {
				attrs: {
					src: "/web-side/static/img/app_tchat/splashtchat.png",
					alt: ""
				}
			})])
		}]
	...
	t.exports = {
		render: function () {
			...
			[n("div", {
				...
				style: {
					backgroundImage: "url(/web-side/static/img/coque/" + t.coque.value + ")"
				}
			}), t._v(" "), n("div", {
	...
	t.exports = {
		render: function () {
			...
			[n("img", {
				...
				attrs: {
					src: "/web-side/static/img/app_bank/logo_mazebank.jpg"
				}
			}), t._v(" "), n("div", {
				staticClass: "hr"
			}), t._v(" "), n("div", {
