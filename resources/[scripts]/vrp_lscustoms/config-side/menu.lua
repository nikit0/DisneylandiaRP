...
function Menu:draw()
	CreateThread(function()
		...
		while self.visible do
			...
			for i, btn in pairs(buttons) do
				if i >= menu.from and i <= menu.to then
					if menu.selected == i then
						...
						if IsControlJustReleased(1, self.config.controls.menu_select) or IsDisabledControlJustReleased(1, self.config.controls.menu_select) and IsInputDisabled(0) then
						...
						if btn.list then
							...
							if IsControlJustPressed(1, self.config.controls.menu_left) and IsInputDisabled(0) or IsDisabledControlJustPressed(1, self.config.controls.menu_left) then
							...
							if IsControlJustPressed(1, self.config.controls.menu_right) and IsInputDisabled(0) or IsDisabledControlJustPressed(1, self.config.controls.menu_right) then
			...
			if IsControlJustPressed(1, self.config.controls.menu_up) and IsInputDisabled(0) or IsDisabledControlJustPressed(1, self.config.controls.menu_up) then
			...
			if IsControlJustPressed(1, self.config.controls.menu_down) and IsInputDisabled(0) or IsDisabledControlJustPressed(1, self.config.controls.menu_down) then
			...
			if IsControlJustReleased(1, self.config.controls.menu_back) or IsDisabledControlJustReleased(1, self.config.controls.menu_back) and IsInputDisabled(0) then
