RegisterNetEvent("vrp-character:normalSpawn")
RegisterNetEvent("vrp-character:characterCreate")
...
AddEventHandler("vrp-character:characterCreate", function()
	doStatus = 1
...
AddEventHandler("vrp-character:normalSpawn", function(firstspawn)
	if firstspawn then
...
function refreshDefaultCharacter()
	TaskPlayAnim(PlayerPedId(), "move_f@multiplayer", "idle", 3.0, 3.0, -1, 15, 5.0, 0, 0, 0)
	SetPedDefaultComponentVariation(PlayerPedId())
	ClearAllPedProps(PlayerPedId())
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		SetPedComponentVariation(PlayerPedId(), 1, -1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 3, 15, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 4, 97, 1, 2)
		...
		SetPedComponentVariation(PlayerPedId(), 1, -1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 3, 15, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 4, 4, 1, 2)
		SetPedComponentVariation(PlayerPedId(), 5, -1, 0, 2)
...
RegisterNUICallback('cDoneSave', function(data, cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(), 1, -1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 3, 2, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 4, 4, 1, 2)
		SetPedComponentVariation(PlayerPedId(), 5, -1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 6, 1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 7, -1, 0, 2)
		...
		SetPedComponentVariation(PlayerPedId(), 9, -1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 10, -1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 11, 2, 0, 2)
		SetPedPropIndex(PlayerPedId(), 0, -1, 0, 2)
	...
	TriggerServerEvent("vrp-character:finishedCharacter", characterNome, characterSobrenome, characterAge, currentCharacterMode)
end)
