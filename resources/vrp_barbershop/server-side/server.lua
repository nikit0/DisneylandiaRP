...
local cfg = module("vrp_barbershop","config-side/barbershop")
...
local function build_client_barbershops(source)
	...
	if user_id then
		for k,v in pairs(barbershops) do
			...
			vRPclient._addMarker(source,21,x,y,z-0.6,0.5,0.5,0.4,255,0,0,50,15)
...
AddEventHandler("dlgames-barbershop:init", function(user_id)
