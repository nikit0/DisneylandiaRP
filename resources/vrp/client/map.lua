...
function tvRP.addMarker(m,x,y,z,sx,sy,sz,r,g,b,a,visible_distance)
	...
	if marker.visible_distance == nil then marker.visible_distance = 15 end
...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in pairs(areas) do
			...
			if IsControlJustPressed(0,194) or IsControlJustPressed(0,25) or IsControlJustPressed(0,200) and IsInputDisabled(0) then
