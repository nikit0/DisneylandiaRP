RegisterNetEvent("dlgames-character:normalSpawn")
RegisterNetEvent("dlgames-character:characterCreate")
...
AddEventHandler("dlgames-character:characterCreate",function()
	doStatus = 1
...
AddEventHandler("dlgames-character:normalSpawn",function(firstspawn)
	if firstspawn then
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	TriggerServerEvent("dlgames-character:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
